...
const FinanceView: React.FC = () => {
  ...
  const renderKPIs = () => {
    ...
    return (
      <>
        <StatCard label="Receita Mensal" value={stats?.revenue ? `R$ ${stats.revenue.toLocaleString('pt-BR')}` : 'R$ 0,00'} trend="+12%" color="primary" />
        <StatCard label="Ocupação Média" value={stats?.occupancy ? `${stats.occupancy}%` : '0%'} trend="+5%" color="blue" />
